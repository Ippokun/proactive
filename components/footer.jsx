        ...
        <section className="py-10 bg-gray-900 sm:pt-16 lg:pt-24">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 gap-x-5 gap-y-12 md:grid-cols-4 md:gap-x-12">
                    <div>
                        <p className="text-base text-gray-500">Компани</p>
                    ...
                    <div>
                        <p className="text-base text-gray-500">Тусламж</p>
                        <ul className="mt-8 space-y-4">
                            <li>
                                <Link href="/" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">
                    ...
                    <div>
                        <p className="text-base text-gray-500">Нөөц</p>
                        <ul className="mt-8 space-y-4">
                            <li>
                                <Link href="/" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">
                                    Үнэгүй цахим ном
                    ...
                    <div>
                        <p className="text-base text-gray-500">Нэмэлт холбоос</p>
                        <ul className="mt-8 space-y-4">
                            <li>
                                <Link href="/" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">
                                    Хэрэглэгчийн дэмжлэг
                ...
                <div className="flex flex-wrap items-center justify-between">
                    {/* <img className="h-8 auto md:order-1" src="asset/proLogoFooter.png" alt="" /> */}
