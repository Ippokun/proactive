...
const Dashboard = () => {
  ...
  const handleNavigateToUserReport = () => {
    router.push('/admin/report_users');
  };
  ...
  const fetchAdminDashboardData = async () => {
    try {
        ...
        setTotalUsers(data.totalUsers);  // Make sure this value is valid
  ...
  useEffect(() => {
    console.log('Updated totalUsers:', totalUsers); // Log when state changes
  }, [totalUsers]);
      ...
      <div className="flex h-screen bg-gray-200">
        ...
        <div className={`fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0 ${
          ...
          <nav className="mt-10">
            {/* Navigation Items */}
            <Link
                href="/admin"  // Replace with the correct path
                        ...
                        <div className="flex flex-wrap -mx-6">
                            <div className="w-full px-6 sm:w-1/2 xl:w-1/3">
                                <div className="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                    ...
                                    <div className="mx-5">
                                        <h4 className="text-2xl font-semibold text-gray-700">{totalUsers}</h4>
                ...
                <div className="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                  <div className="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                    <table className="min-w-full">
                      <thead>
                        <tr>
                          <th className="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Овог</th>
                          <th className="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Нэр</th>
                          <th className="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Хэрэглэгч төрөл</th>
                          <th className="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Имэйл</th>
                          ...
                          <tr key={index}>
                            <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                              <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                  <div className="text-sm font-medium leading-5 text-gray-900">{user.last_name}</div>
                                  {/* <div className="text-sm leading-5 text-gray-500">{user.email}</div> */}
                                </div>
                              </div>
                            </td>
                            <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                              <div className="text-sm leading-5 text-gray-900">{user.first_name}</div>
                              {/* <div className="text-sm leading-5 text-gray-500">{user.email}</div> */}
                            </td>
                            <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
